...
var second_stat : stat_firefly
var action : action_firefly
var second_action : action_firefly

func _init():
	action = preload("res://ressources/firefly/action/inverse_firefly.tres").duplicate()
	stat = preload("res://ressources/firefly/stat/green_firefly.tres").duplicate()
func _ready():
